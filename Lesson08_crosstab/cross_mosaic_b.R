...
#datasetを読み込む
remarrigewill_b <- read_csv("Lesson08_crosstab/remarrigewill_b.csv")

print(remarrigewill_b)
view(remarrigewill_b)

#変数を箱に入れるよ
gender <- (remarrigewill_b$gender)
remarrige_will <- (remarrigewill_b$remarrige_will)

#genderと再婚意思をカテゴリ変数に変換
remarrigewill <- remarrigewill_b %>%
